// Canonical content registry for the static /experience/ route.
// Keep guide copy and practical facts here; index.html owns presentation and filtering.
const EXPERIENCE_LAST_CHECKED = "August 2026";
const EXPERIENCE_SECTIONS = [
    {
        ...
        intro: "Every route starts on Port Island. Learn the small machine that moves you between the labs, the harbor, and the rest of Kansai, and the whole month becomes legible.",
        groups: [
            {
                id: "port-island",
                title: "Port Island",
                sourceTitle: "Port Island",
                intro: "An 8.33-square-kilometre engineered island built between 1966 and 2009, now home to the Kobe Biomedical Innovation Cluster and your address for October.",
                entries: [
                    {
                        id: "port-liner",
                        title: "The Port Liner",
                        dek: "The front seat is still up for grabs.",
                        summary: "Kobe's automated harbor train is your daily spine. Airport-bound and loop trains share the line before splitting, so check the destination board—especially late at night.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "RIKEN's Kobe campus and Fugaku sit among a cluster of roughly 370 member organisations and more than 12,400 people. The island is purpose-built and quiet after work; treat Sannomiya as your high street for supermarkets, pharmacies, and evenings out.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "October falls between the complex's summer 50-metre pool and winter ice-rink seasons, but the five-lane heated 25-metre pool runs year-round under a glass dome.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The island's western promenade faces the harbor lights and Mount Rokko, with a lit BE KOBE monument and a preserved piece of the machinery that helped turn mountain into land. It is the closest place to clear your head between sessions.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Much of the park sits indoors beneath flowering canopies, with capybaras, free-flight birds, otters, lemurs, and famously motionless shoebills. It is a strong reset after a week of biotech programming and equally useful for partners and families.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "ICOCA solves most transit and small purchases. Seven Bank ATMs accept major foreign cards, konbini fill the island's daily gaps, and an eSIM is usually simpler than pocket wifi for a month.",
                        facts: [
    ...
    },
    {
        ...
        intro: "Ten minutes after leaving Shimin Hiroba, you are in the city's central knot. Everything here fans out from Sannomiya on foot, by bus, or by a train ride shorter than most coffee queues.",
        groups: [
            {
                id: "kobe-city",
                title: "Kobe",
                sourceTitle: "Kobe",
                intro: "Use a month to move beyond the postcard: the shrine behind the city's name, a deliberately broken piece of waterfront, a mountain waterfall, and Japan's great sake coast.",
                entries: [
                    {
                        id: "sannomiya",
                        title: "Sannomiya",
                        dek: "Five railways, one city centre, and a 1,200-year-old name.",
                        summary: "JR, Hankyu, Hanshin, the municipal subway, and the Port Liner converge across a few dense blocks. Learn this station cluster in week one. Five minutes north, Ikuta Shrine explains how the shrine-supporting households called kanbe gave Kobe its name.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The Port of Kobe Earthquake Memorial preserves a collapsed stretch of wharf from 1995. Around it, Port Tower, the Maritime Museum, Kawasaki Good Times World, and Harborland make the classic dusk walk.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Walk from Shin-Kobe into the Rokko mountains for four falls, then take the ropeway over roughly 75,000 plants toward a view of the harbor and Port Island.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Nada-gogo's brewing advantage comes from mineral-rich miyamizu water, Hyogo-grown Yamada Nishiki rice, and centuries of technique. Hakutsuru's preserved Taisho-era brewhouse turns that history into an hour-long walk from rice to pressing.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Pay per ride on an ordinary day. The exceptions are a sightseeing loop, a city-wide digital coupon, and the Port Liner day pass when repeated island trips make them worthwhile.",
                        facts: [
    ...
    },
    {
        ...
        intro: "Kobe has spent a century and a half absorbing outside tastes without losing its own. Follow the city's food logic, then take the train over Mount Rokko to water that predates the mountain town above it.",
        groups: [
            {
                id: "food",
                title: "Food",
                sourceTitle: "Food",
                intro: "The useful spectrum runs from a certified teppan lunch to a discounted depachika bento. A month gives you time for both.",
                entries: [
                    {
                        id: "kobe-beef",
                        title: "Kobe beef, decoded",
                        dek: "The most name-dropped steak on earth is a bureaucratic category—and lunch is the loophole.",
                        summary: "Certified Kobe beef must satisfy Tajima bloodline, Hyogo rearing, marbling, sex, and carcass-weight rules. Look for the official certificate and bronze cow, then compare lunch and dinner menus before booking.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Order in rounds, share dishes, and expect the small unordered tsukidashi appetizer to function as the seating charge. Standing tachinomi bars are cheaper and make meeting the person beside you easier.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Kobe's compact Chinatown is built for a walking lunch: steamed buns, skewers, fried snacks, and sweets sold from windows, with Daimaru's basement food hall immediately beside it.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Convenience stores cover breakfast, quick lunches, ATMs, and coffee. Department-store basement food halls turn dinner into retail theatre—and discount prepared food during the final hour.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Fish-based dashi appears in broths, sauces, and dishes with no visible meat. A saved Japanese dietary card is more reliable than improvised English; current specialist listings and attendee recommendations will age better than a printed restaurant list.",
                        facts: [
            ...
            },
            {
                ...
                intro: "Arima sits over Mount Rokko from Kobe. The two public bathhouses, free foot bath, springheads, and uphill lanes fit into a deliberate half day.",
                entries: [
                    {
                        id: "arima-onsen",
                        title: "Arima Onsen",
                        dek: "Gold water, silver water, and a 1,400-year bathing habit.",
                        summary: "Arima's iron-and-salt kinsen oxidises rust-brown in the air; its clear ginsen is carbonated and classified locally as a radium spring. Do the town on a weekday: gold bath, foot bath, crackers, then silver bath.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Arima's flagship public bath sits in the old town and reopened after renovation in March 2026. A free foot bath outside offers the same gold water without the full bathing ritual.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Five minutes uphill from Kin no Yu, the quieter public bath blends clear carbonated water with a spring classified locally as radioactive. Gold first and silver second is the useful order.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Kin no Yu and Gin no Yu did not publish a tattoo ban when this guide was checked, but absence of a posted rule is not a guarantee. Large spas and ryokan may explicitly refuse tattooed guests; private reserved baths remove the communal-bath question.",
                        facts: [
    ...
    },
    {
        ...
        intro: "Osaka is an evening, Kyoto and Nara are day trips, Himeji is a direct run west, and Koyasan earns an overnight. Times below separate the Port Liner leg from the train leaving Sannomiya.",
        groups: [
            {
                id: "osaka",
                title: "Osaka",
                sourceTitle: "Osaka",
                intro: "Treat Osaka as a second neighbourhood. Three railway companies run the same corridor and deposit you in different parts of the city.",
                entries: [
                    {
                        id: "osaka-railways",
                        title: "Three railways, one corridor",
                        dek: "Choose by destination, not by brand.",
                        summary: "JR is fastest for Umeda and onward connections. Hanshin is the cleanest route to Namba and Dotonbori. Hankyu is a slower, handsome ride into north Umeda.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The Glico runner and giant mechanical restaurant signs deliver the expected sensory overload. Hozenji Yokocho drops the volume around Mizukake Fudo, a statue covered by decades of water and moss.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The enormous Shishiden lion hall is said to swallow misfortune and call in victory, which keeps students and businesspeople visiting before important moments.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The Umeda Sky Building's 173-metre observatory gives you Osaka Bay, the Yodo River, and the city grid. Pair sunset above with dinner in Umeda's department-store basements below.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Museums, civic architecture, and Nakanoshima Qross now share the island where the Dojima Rice Exchange helped formalise futures trading. Qross is the Osaka node of the same regenerative-medicine ecosystem you live beside in Kobe.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The relevant deadline is where you sleep on Port Island. The final airport/medical-branch train leaves Sannomiya at 00:00; later 00:07 and 00:15 trains still serve the north loop, including Shimin Hiroba, but not the southern lab stops.",
                        facts: [
            ...
            },
            {
                ...
                intro: "Four weekends put two former capitals, an original castle keep, an island, and a mountain monastery within reach.",
                entries: [
                    {
                        id: "kyoto",
                        title: "Kyoto",
                        dek: "Eleven centuries of capital history—and the lab that taught adult cells to forget what they were.",
                        summary: "CiRA remains a working research institute, not a tourist stop; arrange professional visits in advance. For everyone else, October brings mild weather, thinner pre-foliage crowds, the October 22 Jidai Matsuri, and Fushimi Inari at any hour.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Todai-ji anchors the old capital with a Buddha completed in 752, while the park's sika deer have perfected bowing for crackers. Through trains make the trip possible without changing in Osaka.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The White Heron is Japan's largest surviving original castle keep and one of the country's first World Cultural Heritage sites. You can see it from the station and walk straight toward it.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Tadao Ando's Yumebutai terraces an excavated hillside, the Nojima Fault museum preserves the earthquake rupture, and the Akashi Kaikyo Bridge still carries the extra metre the 1995 quake added between its towers.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "An overnight shukubo stay pairs a tatami room and shojin ryori meals with an invitation to morning prayer. Walk Okunoin after dark, then return beneath the cedars in daylight.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "For these Kansai trips, individual fares on ICOCA usually beat the available visitor passes. The nationwide JR Pass is built for long shinkansen itineraries, not a month based in Kobe.",
                        facts: [
    ...
    },
    {
        ...
        intro: "A washing machine, the right train stop, and people you want to see again matter more over 31 days than a marble lobby. Choose the shape of daily life before you optimise the room.",
        groups: [
            {
                id: "where-to-stay",
                title: "Where to stay",
                sourceTitle: "Where to Stay",
                intro: "Week-pass visitors need zero friction. Month-long builders need a kitchen, laundry, and other humans—in roughly that order.",
                entries: [
                    {
                        id: "portopia-hotel",
                        title: "Kobe Portopia Hotel",
                        dek: "The hotel built for the island's last great invitation to the future.",
                        summary: "The 746-room partner hotel sits at Shimin Hiroba with 13 restaurants and bars. Its Kobe Residence long-stay plan can undercut ordinary nightly hotel rates for a full month.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The Sanctuary, Biopunk House, Aevitas, and ZuCity Japan follow the hacker-house pattern: shared rooms, kitchens, and colleagues. The Sanctuary is tied to the Residency track and its lab and regulatory access.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Chuo-ku covers both Sannomiya and Port Island. Sannomiya trades a short commute for a neighbourhood that stays awake; Port Island wins on proximity and loses on evening life.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Week-pass professionals should minimise transit and booking friction. Month-long builders should prioritise community, a real kitchen, and laundry. A partner joining for the closing stretch may make a hotel or larger apartment the better compromise.",
                        facts: [
            ...
            },
            {
                ...
                intro: "The island goes home at six. Your social life runs on the event and Sannomiya; reliable drop-in coworking lives across the bridge too.",
                entries: [
                    {
                        id: "sannomiya-social",
                        title: "The Sannomiya izakaya grid",
                        dek: "A month is long enough to become a regular.",
                        summary: "Higashimon-gai and the streets around Ikuta Shrine stack tiny bars and izakaya floor by floor. Standing tachinomi counters are the lowest-friction rooms for meeting people outside your own group.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "All late Port Liner trains call at Shimin Hiroba, but only airport-bound trains continue to Iryo Center and the southern lab stops. Your accommodation determines whether midnight or 00:15 is the real deadline.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Reserve days ahead, give an exact headcount, and call if plans change. A course with two-hour nomihodai turns the bill into one predictable per-person number.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "A training-room business with a calm coworking floor, power at every seat, printing, a cafe corner, and a small library. Useful in the daytime; admissions close before the floor itself.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The Motomachi branch puts you beside the arcades and Chinatown. The Shin-Kobe flagship sits one minute from the shinkansen, useful when work runs right up to a Tokyo train.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Use the summit weekends for visitors and dinners, October 26 for the Frontier Human Fashion Show, and nearby conferences as shared field trips. Book a table for eight in week one before you know the eight people.",
                        facts: [
            ...
            },
            {
                ...
                intro: "Thirty-one days is a long absence and an unusually good base for sharing Japan. The practical case is stronger than the romantic one.",
                entries: [
                    {
                        id: "partner-case",
                        title: "The case you make at home",
                        dek: "A weekday radius most tourists would trade their itinerary for.",
                        summary: "While you are in sessions, a partner can reach Kyoto, Nara, Osaka, Arima, and Kobe's own waterfront without changing accommodation. October is mild, beyond the peak of typhoon season, and well suited to walking.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The on-island museum pairs hands-on science rooms with a 230-seat planetarium. Late Friday, weekend, and holiday shows make it possible to go after a full conference day.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "For a partner joining only part of the month, the October 24–31 closing stretch contains the second summit weekend and the October 26 fashion show. Full-month pairs can split an apartment or ask about event housing.",
                        facts: [
    ...
    },
    {
        ...
        intro: "The clean arrival is island to island by boat. Keep the land backups in your pocket, arrive before opening day if you can, and move your body onto Japan time before the programme gets dense.",
        groups: [
            {
                id: "getting-there",
                title: "Getting there",
                sourceTitle: "Getting There",
                intro: "Kansai International is the main gateway; Kobe Airport is the sleeper option one bridge south of the event. Every route below ends on Port Island.",
                entries: [
                    {
                        id: "arrival-short-version",
                        title: "The short version",
                        dek: "KIX. Shuttle. Ferry. Port Liner.",
                        summary: "From KIX arrivals, take the free shuttle to the ferry pier, cross Osaka Bay to Kobe Airport, then board the Port Liner across the Sky Bridge to your island station.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Kansai International handles the broad international network. Kobe Airport is primarily domestic with limited international routes and lands you one bridge from the venue. Tokyo works when paired with a domestic hop, shinkansen, or BioJapan—but adds another leg.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The boat replaces a longer land transfer with a direct crossing between artificial islands. Ask for the combined ferry-plus-Port-Liner ticket at KIX; it costs the same as the ferry alone.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "The limousine bus reaches Sannomiya without transfers; JR West's visitor Haruka ticket connects KIX to Kobe via Osaka. Both keep the trip moving when the ferry is cancelled or finished for the night.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Many attendees will qualify for short-stay visa exemption, while others must apply in advance. Nationality rules, passport requirements, and allowed activities change; the Japanese Ministry of Foreign Affairs is the authority.",
                        facts: [
            ...
            },
            {
                ...
                intro: "Jet lag is a tax on short trips; a month-long event is how you stop paying it. Put the fog onto move-in days, not the summits.",
                entries: [
                    {
                        id: "clock-math",
                        title: "The clock math",
                        dek: "Japan stays on UTC+9 all year.",
                        summary: "Through October, Kobe is 16 hours ahead of San Francisco and 13 ahead of New York. Britain and central Europe shift one hour on October 25; Japan does not.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Use late-afternoon light, walk, eat at local dinner time, and stay awake until at least 21:30 if you can. If you must nap, keep it short enough that it does not become your first night's sleep.",
                        facts: [
                    ...
                    },
                    {
                        ...
                        summary: "Use the first mornings for outdoor light and the first afternoons for ICOCA, groceries, and learning your station. An early 04:30 wake-up is also a useful call window back to North America.",
                        facts: [
