...
window.MIRAI_COPY = {
  ...
  proof: {
    ...
    headline: `Here are all <span class="early-page__proof-count">51</span> speakers.`,
    ...
    /* Speakers 05–51. The headline above says "all 51", and the
       last number is highlighted, so THIS LIST MUST HOLD EXACTLY
       47 NAMES. Add or remove one and the count breaks. */
    roster: [
      `Brian Kennedy`,
      `Marian Goodell`,
      `Prof. Motoshi Hayano`,
      ...
      `Patri Friedman`,
      `Natalie S. Coles de Grey`,
      `Walter Marion Patterson`,
      `Matt Scholz`,
      `Todd Porter`,
      `Josh Mann`,
      `Florian`,
